...
suite('ExtHostWebview', () => {
	...
	test('asWebviewUri for remote with / and + in name', () => {
		...
		assert.strictEqual(
			webviewUri.toString(),
			`https://vscode-remote.ssh-002dremote-002blocalhost-003dfoo-002fbar.vscode-resource.vscode-cdn.net/Users/cody/x.png`,
			'Check transform');
	...
	test('asWebviewUri for remote with port in name', () => {
		...
		assert.strictEqual(
			webviewUri.toString(),
			`https://vscode-remote.localhost-003a8080.vscode-resource.vscode-cdn.net/Users/cody/x.png`,
			'Check transform');
